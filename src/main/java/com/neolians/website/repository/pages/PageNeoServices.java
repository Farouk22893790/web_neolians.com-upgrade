...
public class PageNeoServices {
    ...
    public static final ButtonElement neoexternalisaton=new ButtonElement("neo externalisation",By.xpath("//img[@src='https://neolians.com/wp-content/uploads/2022/09/neo.extern-1-150x150-1.png']"));
    ...
    public static final ButtonElement neomobile=new ButtonElement("neo mobile",By.xpath("//img[@src='https://neolians.com/wp-content/uploads/2022/09/neo.mobile-1-150x150-1.png']"));
