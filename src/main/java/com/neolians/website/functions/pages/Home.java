...
public class Home {
    ...
    public static void openPageNeoExternalisationFromNosoffres() {
        ...
        PageMenu.nosOffres.waitForElementPresent(5000);
        PageMenu.nosOffres.moveTo();
        PageMenu.NeoServicesButton.waitForElementPresent(5000);
    ...
    public static void openPageNosPartenaires() {
        ...
        PageMenu.entreprise.waitForElementPresent(5000);
    ...
    public static void openPageNeoEditeurfromNosOffres() {
        PageMenu.nosOffres.waitForElementPresent(5000);
        PageMenu.nosOffres.moveTo();
        PageMenu.Neoservice.waitForElementPresent(5000);
    ...
    public static void openPageNeoMobile() {
        ...
        PageMenu.nosOffres.waitForElementPresent(10000);

        PageMenu.nosOffres.moveTo();
        PageMenu.NeoServicesButton.waitForElementPresent(10000);
    ...
    public static void openNosprojets() {
        PageHome.url.openUrl();
        PageMenu.entreprise.waitForElementPresent(10000);
