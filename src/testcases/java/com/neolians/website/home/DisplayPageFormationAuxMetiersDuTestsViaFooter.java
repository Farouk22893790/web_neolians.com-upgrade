...
public class DisplayPageFormationAuxMetiersDuTestsViaFooter extends NeoliansTestcase {

    @RepeatedIfExceptionsTest(repeats = 1, suspend = 5000L, name = "Check FrmationAuxMetiersDuTests Page  via Footer")
    void CheckPageFormationAuxMetiersDuTestViaFooter()
    {
        ...
        Report.newStep(4, "Open Page Formation-Aux-Metier-Du-Test via Footer");
        Home.openPageFormationAuxMetiersDuTestViaFooter();

        Report.newStep(5, "Verify FormationAuxMetiersDuTest Page");
